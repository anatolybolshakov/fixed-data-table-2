...
var FixedDataTableCell = createReactClass({
  ...
  componentWillReceiveProps(props) {
    ...
    if (props.isColumnReordering) {
      ...
      if (props.columnKey === props.columnReorderingData.columnKey) {
        ...
        var cellIsBeforeOneBeingDragged = (document.dir !== "rtl") 
                                          ? reorderCellCenter > centerOfThisColumn
                                          : reorderCellCenter < centerOfThisColumn;

        var cellWasOriginallyBeforeOneBeingDragged =  (document.dir !== "rtl") 
        ...
        if (cellIsBeforeOneBeingDragged) {
          if (reorderCellLeft < centerOfThisColumn && (document.dir !== "rtl")
          || reorderCellLeft > centerOfThisColumn && (document.dir === "rtl")) {
          ...
          if (reorderCellRight > centerOfThisColumn && (document.dir !== "rtl")
          ||  reorderCellRight < centerOfThisColumn && (document.dir === "rtl")) {
            changedPosition = true;
            if (cellWasOriginallyBeforeOneBeingDragged) {
              newState.displacement = 0;
            } else {
  ...
  _onColumnReorderMouseDown(/*object*/ event) {
    this.props.onColumnReorder(
      this.props.columnKey,
      this.props.width,
      this.props.left, //(document.dir !== "rtl") ? this.props.left : this.props.columnGroupWidth - this.props.left,
      event
    );
  },
});
